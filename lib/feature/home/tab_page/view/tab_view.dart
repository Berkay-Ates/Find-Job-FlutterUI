...
class FindJobApiTabView extends StatefulWidget {
  const FindJobApiTabView({Key? key, this.initialPage, this.page}) : super(key: key);

  final TabEnums? initialPage;
  final Widget? page;

  @override
  State<FindJobApiTabView> createState() => _FindJobApiTabViewState();
}

class _FindJobApiTabViewState extends State<FindJobApiTabView> with TickerProviderStateMixin {
  @override
